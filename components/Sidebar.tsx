  ...
  return (
    ...
    >
      ...
      <button
        ...
        className="absolute bottom-24 left-1/2 -translate-x-1/2 w-10 h-10 bg-surface-secondary hover:bg-border-primary rounded-lg flex items-center justify-center transition-colors"
      >
